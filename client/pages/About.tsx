  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center space-y-8 mb-16">
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              We're transforming how martial arts knowledge is shared, learned, and monetized. 
              No longer do instructors have to sacrifice time for money—now they can teach their skills online and build thriving businesses.
            </p>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-lg text-muted-foreground">
              <p>
                Traditional martial arts instruction has always been bound by physical location and limited class sizes. 
                Master instructors could only teach as many students as their dojo could hold, forcing them to choose between 
                their passion for teaching and financial stability.
              </p>
              <p>
                <strong className="text-foreground">Gojo changes everything.</strong> We've created the world's first comprehensive 
                martial arts marketplace where expert instructors can digitize their knowledge, reach global audiences, 
                and build sustainable income streams—all while maintaining the quality and authenticity of traditional training.
              </p>
              <p>
                Every technique, every philosophy, every hard-earned skill can now be preserved, shared, and monetized. 
                This is how martial arts education evolves for the digital age.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <Card className="border-primary/20">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  Transform your expertise into scalable income. Teach thousands while you sleep. 
                  Build your brand beyond your local community.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-accent/20">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  Learn from world-class masters regardless of location. Train at your pace, 
                  on your schedule, with unlimited access to expert instruction.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="bg-muted/30 rounded-3xl p-8 lg:p-12 mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              The martial arts industry has been stuck in the past, limiting both instructors and students
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-foreground">Before Gojo</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <Clock className="w-5 h-5 text-red-500 mt-1 flex-shrink-0" />
                  <div>
                    <div className="font-medium">Time for Money Trade-off</div>
                    <div className="text-sm text-muted-foreground">Instructors limited by hours in the day and students in the room</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Students couldn't access the best instructors if they lived elsewhere</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Revenue capped by physical class capacity and local market rates</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Master techniques often died with their creators</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-foreground">With Gojo</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                  <div>
                    <div className="font-medium">Scalable Income</div>
                    <div className="text-sm text-muted-foreground">Create once, sell forever. Earn while you sleep</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Teach students from around the world, 24/7</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">No caps on student count or revenue growth</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Ancient knowledge preserved and shared for generations</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Success Stories */}
        <div className="mb-20">
          <h2 className="text-3xl font-bold text-foreground text-center mb-12">Success Stories</h2>
              ...
              <CardContent className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Wing Chun Specialist</p>
                  </div>
                </div>
                <blockquote className="text-muted-foreground italic mb-4">
                  "In my dojo, I could teach maybe 50 students. On Gojo, I've reached over 800 students from 15 countries. 
                  I've more than tripled my income while preserving authentic Wing Chun techniques for future generations."
                </blockquote>
              ...
              <CardContent className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Karate & Self-Defense</p>
                  </div>
                </div>
                <blockquote className="text-muted-foreground italic mb-4">
                  "Gojo gave me financial freedom I never thought possible. I was struggling to make ends meet with my small dojo. 
                  Now I teach women's self-defense to thousands while maintaining my authentic teaching style."
                </blockquote>
                <div className="flex items-center gap-4 text-sm">
                  <div className="flex items-center gap-1">
                    <DollarSign className="w-4 h-4 text-primary" />
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          <Card className="text-center">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground">
                We preserve the integrity and tradition of martial arts while embracing modern technology for delivery.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground">
                We're committed to helping martial arts instructors build sustainable, profitable online businesses.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground">
                Connecting martial artists worldwide to learn, grow, and preserve ancient wisdom for future generations.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="bg-gradient-to-r from-primary/10 to-accent/10 rounded-3xl p-8 lg:p-12 text-center">
          <h2 className="text-3xl font-bold text-foreground mb-4">Ready to Transform Your Teaching?</h2>
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join hundreds of martial arts instructors who have already discovered the freedom of teaching online. 
            Your expertise deserves to reach the world.
          </p>
