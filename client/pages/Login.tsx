          ...
          <div className="space-y-8 order-2 lg:order-1">
            <div className="space-y-4">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-muted-foreground">
                Continue your martial arts journey. Sign in to access your courses, 
                track progress, and connect with the community.
              </p>
            </div>

            {/* Benefits */}
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-foreground">When you sign in, you get:</h3>
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-primary" />
                  <span className="text-sm lg:text-base">Access to your enrolled courses</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-primary" />
                  <span className="text-sm lg:text-base">Progress tracking and achievements</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-primary" />
                  <span className="text-sm lg:text-base">Community discussions and support</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-primary" />
                  <span className="text-sm lg:text-base">Personalized recommendations</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div className="text-center">
                ...
                <div className="text-xs lg:text-sm text-muted-foreground">Active Students</div>
              </div>
              <div className="text-center">
                <div className="text-2xl lg:text-3xl font-bold text-accent">500+</div>
                <div className="text-xs lg:text-sm text-muted-foreground">Video Lessons</div>
              </div>
              <div className="text-center">
                <div className="text-2xl lg:text-3xl font-bold text-secondary">4.9★</div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Access hundreds of expert-led martial arts courses from beginner to advanced levels.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Monitor your training journey with detailed analytics and achievement badges.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Connect with fellow martial artists and share your training experiences.
                </p>
              </CardContent>
            </Card>
          </div>
