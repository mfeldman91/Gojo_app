  ...
  const progressPosts = [
    {
      id: 1,
      date: "2024-01-15",
      content: "Just finished my first boxing combination sequence! The 1-2-3 combo is finally feeling natural. Took me 3 weeks but the muscle memory is starting to kick in 🥊",
      likes: 12,
      comments: 3,
    ...
    },
    {
      id: 2,
      date: "2024-01-12", 
      content: "Attempted my first proper Muay Thai roundhouse kick today. Still working on the hip rotation but getting better balance. My shin conditioning is also improving!",
      likes: 8,
      comments: 5,
    ...
    },
    {
      id: 3,
      date: "2024-01-10",
      content: "30 days into my martial arts journey! Started with zero experience and now I can see real progress. The Gojo instructors make everything so clear and easy to follow.",
      likes: 24,
      comments: 7,
              ...
              <div className="flex flex-col md:flex-row items-start gap-6">
                ...
                <div className="flex-1 space-y-4">
                  <div>
                    ...
                    <p className="text-muted-foreground">Martial Arts Enthusiast</p>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="text-center p-3 bg-muted/50 rounded-lg">
                      <div className="text-2xl font-bold text-accent">{userStats.daysTraining}</div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-foreground">Your Training Journey</h2>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 space-y-3">
                        <div className="flex items-center gap-2">
                          ...
                          <Badge variant="secondary" className="text-xs">{post.course}</Badge>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center gap-3 p-3 bg-primary/10 rounded-lg">
                  ...
                  <div>
                    <div className="font-semibold text-sm">First Course Complete!</div>
                    <div className="text-xs text-muted-foreground">Boxing Fundamentals</div>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 bg-accent/10 rounded-lg">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">Consistent training</div>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 bg-secondary/10 rounded-lg">
                  <Clock className="w-8 h-8 text-secondary" />
                  <div>
                    <div className="font-semibold text-sm">50 Hours Trained</div>
                    <div className="text-xs text-muted-foreground">Time dedication</div>
                  </div>
                </div>
              </CardContent>
            </Card>
