  ...
  const faqs = [
    {
      ...
      answer:
        "Yes, you can cancel your All-Access Pass subscription at any time. You'll continue to have access until the end of your current billing period.",
    },
    {
      question:
        "What happens if I buy individual courses and then get the All-Access Pass?",
      answer:
        "Your individual course purchases remain yours forever, even if you cancel the All-Access Pass. The subscription gives you access to additional courses and features.",
    },
    {
      question: "Do I need special equipment to train?",
      answer:
        "Most courses require minimal equipment. We'll clearly list any equipment needed for each course. Many techniques can be practiced with just body weight.",
    },
    {
      question: "Are the courses suitable for complete beginners?",
      answer:
        "Absolutely! We have courses designed specifically for beginners, with step-by-step instruction and progressive skill building.",
    },
    {
      question: "Can I download videos for offline viewing?",
      answer:
        "Yes, All-Access Pass subscribers can download videos through our mobile app for offline viewing. Individual course purchases also include download access.",
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <div className="text-center space-y-4 lg:space-y-6 mb-12 lg:mb-16">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto">
            Start your martial arts journey with flexible pricing options. From
            individual courses to unlimited access - find the perfect plan for
            your goals.
          </p>
        ...
        <div className="grid lg:grid-cols-3 gap-6 lg:gap-8 mb-16 lg:mb-20">
          {plans.map((plan, index) => (
            <Card
              key={index}
              className={`relative ${plan.popular ? "border-primary shadow-lg scale-105" : ""} transition-all hover:shadow-xl`}
            >
              {plan.popular && (
                ...
                <div className="space-y-3">
                  {plan.features.map((feature, featureIndex) => (
                    <div key={featureIndex} className="flex items-start gap-3">
                      ...
                      <span
                        className={`text-sm lg:text-base ${feature.included ? "text-foreground" : "text-muted-foreground"}`}
                      >
                        {feature.name}
                      </span>
                    </div>
            ...
            {[
              {
                ...
                description:
                  "Crystal-clear 1080p+ video instruction from master teachers",
              },
              {
                icon: (
                  <Download className="w-6 h-6 lg:w-8 lg:h-8 text-accent" />
                ),
                title: "Offline Access",
                description:
                  "Download videos and train anywhere, even without internet",
              },
              {
                icon: (
              ...
              },
              {
                ...
                title: "Certificates",
                description:
                  "Earn official completion certificates for your progress",
              },
            ].map((feature, index) => (
              <Card
                key={index}
          ...
          <Card className="max-w-2xl mx-auto border-primary/20">
            <CardContent className="p-6 lg:p-8 space-y-4">
              ...
              <p className="text-sm lg:text-base text-muted-foreground">
                ...
                asked. We're confident you'll love training with Gojo.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="text-center bg-gradient-to-r from-primary/10 to-accent/10 rounded-2xl lg:rounded-3xl p-6 lg:p-12">
          ...
          <p className="text-base lg:text-xl text-muted-foreground mb-6 lg:mb-8 max-w-2xl mx-auto">
            Join thousands of students mastering martial arts with Gojo. Start
            with our free trial and experience the difference.
          </p>
