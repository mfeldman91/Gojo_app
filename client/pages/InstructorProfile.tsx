              ...
              <div className="flex flex-col lg:flex-row items-start gap-8">
                <div className="flex flex-col items-center gap-4">
                  <Avatar className="w-32 h-32">
                    <AvatarImage src="" />
                    <AvatarFallback className="bg-primary text-primary-foreground text-4xl">CW</AvatarFallback>
                  </Avatar>
                ...
                <div className="flex-1 space-y-6">
                  <div>
                    ...
                    <p className="text-xl text-muted-foreground mb-2">{instructor.title}</p>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="text-center p-4 bg-secondary/10 rounded-lg">
                      <div className="text-2xl font-bold text-secondary">{instructor.courses}</div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold text-foreground">Courses by Master Chen</h2>
                <div className="text-sm text-muted-foreground">
                  {instructorCourses.length} courses • {instructor.students} total students
                </div>
              </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>What students say about Master Chen's teaching</CardDescription>
              </CardHeader>
                ...
                {[
                  {
                    ...
                    review: "Master Chen's teaching style is incredible. He breaks down complex movements into easy-to-understand steps. I've learned more in 3 months than I did in a year elsewhere.",
                    date: "2 weeks ago"
                  },
                  {
                    ...
                    review: "The traditional forms course is amazing. Master Chen's attention to detail and historical context makes every lesson fascinating. Highly recommend!",
                    date: "1 month ago"
                  }
                ].map((review, index) => (
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Revenue from published courses</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {instructorCourses.map((course) => (
                ...
                <div className="pt-2 border-t">
                  <div className="flex justify-between font-bold">
                    ...
                    <span className="text-primary">{instructor.socialProof.totalEarnings}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-sm text-muted-foreground">Years on Gojo</span>
                  <span className="font-semibold">{instructor.socialProof.yearsOnGojo}</span>
                </div>
                <div className="flex justify-between">
